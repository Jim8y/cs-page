...
\usepackage[backend=biber,style=ieee,block=ragged,doi=false,url=false,sorting=ydnt]{biblatex}
\usepackage{xpatch}
...
\begin{minipage}[t]{\textwidth+\marginparwidth+\marginparsep}%
  {\Huge {#2} \hfill #1}\\[-0.3\baselineskip]%
...
\Section{Research}
Security and Privacy, Blockchains, Applied Cryptography, Trusted Hardware
